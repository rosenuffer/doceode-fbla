...
function ReorderItem(_a, externalRef) {
  ...
  var layout = (0, import_react42.useRef)(null);
...
function useSpring(source, config) {
  ...
  var activeSpringAnimation = (0, import_react43.useRef)(null);
  var value = useMotionValue(isMotionValue(source) ? source.get() : source);
  (0, import_react43.useMemo)(function() {
...
function useAnimationFrame(callback) {
  ...
  var isStatic = (0, import_react45.useContext)(MotionConfigContext).isStatic;
...
function useCycle() {
  ...
  var index2 = (0, import_react47.useRef)(0);
  var _a = __read((0, import_react47.useState)(items[index2.current]), 2), item = _a[0], setItem = _a[1];
  return [
    item,
    function(next) {
